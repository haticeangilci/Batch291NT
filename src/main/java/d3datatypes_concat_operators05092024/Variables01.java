...
public class Variables01 {
    public static void main(String[] args) {
        ...
        double cellWeight = 0.0000000000028;
        System.out.println(cellWeight);//2.8E-12// 2.8 x 10 üzeri 12 olarak bilimsel hesaplamadır.
        ...
        System.out.println(firstLetterOfTheName);// H
